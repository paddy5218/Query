...
public class SignupActivity extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            ...
            data += "&ran=" + URLEncoder.encode(ran,"UTF-8");

            link = "http://140.130.33.139/signup.php" + data;
        ...
        if (jsonStr != null) {
            try {
                ...
                if (query_result.equals("SUCCESS")) {
                    ...
                    Toast.makeText(context, "Data could not be inserted. Signup duplicate.", Toast.LENGTH_SHORT).show();
